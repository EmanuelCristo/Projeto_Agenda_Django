...
class ServicosView(ListView):
    ...
    def get_queryset(self):
        ...
        if qs.count() > 0:
            paginator = Paginator(qs, 1)  # O número 1 aqui é a quantidade por página
...
class ServicoDeleteView(SuccessMessageMixin, DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(request, f'O serviço {self.object} não pode ser excluido. Esse serviço está registrado em ordens de serviço')
